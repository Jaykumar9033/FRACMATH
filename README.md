...
| `.zenodo.json` | Zenodo metadata for the `v1.0.0` archive | DOI publication metadata |
| `ZENODO_RELEASE.md` | Steps for publishing the Zenodo `v1.0.0` record | Release DOI checklist |
