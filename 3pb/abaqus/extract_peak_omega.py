...
if os.path.exists(lc_csv):
    ...
    print('WARNING: %s not found; will use last frame for post-peak.' % lc_csv)
...
print('Field-frame indices -> postpeak: %d (t=%.4f)  last: %d (t=%.4f)'
...
for fi, name in ((pp_fi,   'omega_postpeak.csv'),
                 (pp_fi,   'omega_fully_cracked.csv'),
