...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.96\linewidth]{fig_b1_damage.png}

  \vspace{0.2em}
  \includegraphics[width=0.82\linewidth]{abaqus_fig_damage_last_step.png}

  {\small (c) Abaqus SDV2 damage field from the Oliver-matched UMAT run.}
