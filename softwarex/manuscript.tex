...
A versioned archive DOI will be added to the release metadata when the
SoftwareX submission reaches the archival stage.
...
(Windows 11 Pro, Dell Precision 3660, Intel Core i9-13900 processor with
24 cores and 32 threads, 64~GB RAM, and a 1~TB NVMe SSD).
