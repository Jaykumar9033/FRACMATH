...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.84\linewidth]{fig_b1_damage.png}

  \vspace{0.2em}
  \includegraphics[width=0.84\linewidth]{abaqus_fig_damage_last_step.png}

  \caption{Fully damaged bands for the 2D 3PB benchmark:
    (a) MATLAB peak load, 3.64~kN, 17 elements; (b) MATLAB post-peak,
    0.13~kN at CMOD~$\approx$~0.30~mm, 118 elements; and (c) Abaqus SDV2
    damage field. The damaged crack path is extracted with threshold
    $\omega \ge 0.99$.}
  \label{fig:b1-damage}
\end{figure}
...
\begin{figure}[!htbp]
  ...
  \begin{subfigure}{\linewidth}
    \centering
    \makebox[\linewidth][c]{\includegraphics[width=1.12\linewidth]{nooru_damage_evolution_3x3_crop.png}}
...
% =====================================================================
\section*{Declarations and acknowledgements}
% =====================================================================
...
grant 80NSSC22M0044. \textbf{Declaration of competing interest.}
The authors declare no conflict of interest. \textbf{Declaration of
AI-assisted technologies.} Generative AI tools were used to assist with
manuscript wording, formatting, and implementation support. The scientific
claims, equations, code, numerical results, figures, and references are
