...
\begin{figure}[!htbp]
  ...
  \begin{subfigure}{0.82\linewidth}
    \centering
    \includegraphics[width=\linewidth]{fig_damage_peak_final.png}
  ...
  \begin{subfigure}{0.82\linewidth}
    \centering
    \includegraphics[width=\linewidth]{fig_damage_postpeak_final.png}
...
\begin{figure}[!htbp]
  ...
  \caption{Nooru-Mohamed benchmark: boundary conditions, 3D mesh, and
    damage evolution $\omega$. Only $\omega \ge 0.99$ is shaded in the
...
$\omega \ge 0.99$ are shaded, so the crack path itself stands out from
